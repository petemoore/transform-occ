...
$client.DownloadFile("https://raw.githubusercontent.com/mozilla-releng/OpenCloudConfig/master/userdata/Configuration/nxlog/win10-grenade-elk-debug.conf", "C:\Program Files (x86)\nxlog\conf\nxlog.conf")
